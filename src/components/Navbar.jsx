    ...
    <div className="text-white flex justify-between h-24 max-w-[900px]  mx-auto px-4 items-center">
      ...
      <div onClick={handleNav} className=" block  md:hidden ">
        ...
        <div
          className={
            !nav
              ? "fixed left-0 top-0 w-[60%] border-r ease-in-out duration-500 border-r-gray-900 h-full bg-[#000300]"
              : " fixed left-[-100%] top-0 w-[60%] border-r border-r-gray-900 h-full ease-in-out duration-500 "
          }
        >
